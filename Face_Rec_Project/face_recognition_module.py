...
known_faces_dir = "attendance1/face-recognition-attendance-management/known_faces"
...
for image_file in image_files:
    ...
    # Get face encoding
    encoding = face_recognition_module.face_encodings(image)
...
def start_recognition():
    while True:
        ...
        face_locations = face_recognition_module.face_locations(frame)
        face_encodings = face_recognition_module.face_encodings(frame, face_locations)

        # Loop through each face found in the frame
        for (top, right, bottom, left), face_encoding in zip(face_locations, face_encodings):
            # Check if the face matches any known faces
            matches = face_recognition_module.compare_faces(known_face_encodings, face_encoding)
            name = "Unknown"
